...
在 Imavoyc 佬的原始脚本工具基础上，除了保留原有的剧情脚本与系统脚本处理能力外，还额外整合了 GUI、编码选择、JSON/TXT 文本提取与导回功能，方便日常汉化、校对和回填。

另外新增了 v0 脚本的处理。同时完善了对 v1 脚本和 bp 系统脚本处理能力。完善了各自的反汇编器、汇编器和操作码表以支持更多游戏。
现在完全支持处理 bs5、bsb、bsc、bss 等类型的 v1 脚本。
